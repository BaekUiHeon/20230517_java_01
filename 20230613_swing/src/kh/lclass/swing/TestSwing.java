...
public class TestSwing extends JFrame{
	...
	public TestSwing() {
		...
		setDefaultCloseOperation(EXIT_ON_CLOSE); //X버튼 눌렀을때 resource 정리하고 창 닫기 
		...
		// contentPane.setLayout(new FlowLayout(FlowLayout.RIGHT,40,40));
